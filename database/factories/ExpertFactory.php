...
class ExpertFactory extends Factory
{
    ...
    {
        static $baseUserIds = [1, 2, 3, 4, 5, 6, 7, 8];
        static $baseFirstNames = ['Василий', 'Сергей', 'Петр', 'Магомед', 'Игорь', 'Вадим', 'Алексей', 'Бобер'];
        static $baseLastNames = ['Олохов', 'Бурунов', 'Петров', 'Магомедов', 'Игривый', 'Вадимыч', 'Алексеев', 'Бобров'];
        static $baseProfessions = ['Коуч', 'Коуч', 'Коуч', 'Коуч', 'Коуч', 'Коуч', 'Эксперт по отношениям', 'Эксперт по отношениям'];
        ...
        static $baseBiographies = [
            ...
            'В детстве я очень любил наблюдать за тем, как бабушка пекет пирожки. Теперь я сам их пеку.',
            'Тренер-консультант по теме "Управление персоналом", коуч.Более 9 лет провожу обучение для руководителей в крупных компаниях (Альфа-Банк, Сбербанк, Generali PPF и др.) по темам менеджмента и лидерства.
                Провел более 200 тренингов для руководителей различных уровней (от линейного до топ-менеджмента).
                Также регулярно провожу коуч-сессии.',
            'В детстве я очень любил наблюдать за тем, как бабушка пекет пирожки. Теперь я сам их пеку.',
            'Последние 10 лет активно работаю и развиваюсь в области ораторского мастерства и эффективных коммуникаций.',
            'В детстве я очень любил наблюдать за тем, как бабушка пекет пирожки. Теперь я сам их пеку.',
            'В детстве я очень любил наблюдать за тем, как бабушка пекет пирожки. Теперь я сам их пеку.'
